...
public class LerpComponent : MonoBehaviour
{
	...
	public IEnumerator LerpMove2D(GameObject go, Vector2 startPos, Vector2 dest, Quaternion startRot, Quaternion destRot, float lerpTime, bool sphericalLerp, LerpEasing easingType, bool offscreen)
	{
		float elapsedTime = 0;
